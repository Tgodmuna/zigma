...
const IdentityVerification = () => {
  ...
  return (
    <div className='all flex flex-col justify-between items-center gap-5 bg-white rounded-lg p-6 shadow-md text-center w-full h-[90vh]'>
      <div
        id='camera-holder'
      ...
      <p className='text-gray-600 -mt-[6rem] w-[26rem] text-xl  mb-[3.5rem]'>
        Please, have your BVN ready and stay in a well-lit place. You will need
        to position your face within the camera frame.
      </p>
